<div class="modal fade" id="become_content_partner" tabindex="-1" role="dialog" 
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">
                   We can help monetize your content. Help us know you more! 
                </h4>
            </div>
                ...
                <form class="form-horizontal" role="form" novalidate>
					...
					<div class="col-md-7">
						  ...
						  <div class="control-group">
							...
							<div class="controls">
							  <textarea class="form-control" rows="3" name="contact_message" id="contact_message"></textarea>
							  <p class="help-block"></p>
							</div>
						  </div>
					</div>
					<div class="col-md-12">
						  <div class="control-group">
							<label class="control-label">You have content for what areas? <small> optional</small></label>
							<div class="controls">
								<div class="checkbox">
								  <label class="col-md-3"><input type="checkbox" value="All" name="contact_area_of_interest[]">All</label>
						  ...
						  <div class="form-group">
							<div class="col-sm-12 text-center"><br>
								<input type="hidden" value="Become a content partner" name="form_type">
